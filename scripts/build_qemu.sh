...
echo "    patches from processor/ + bridges/ + include/cosim_protocol.h"
...
cp "${ROOT}/bridges/remote_mmio.h"           "${SRC_DIR}/include/hw/misc/remote_mmio.h"
cp "${ROOT}/include/cosim_protocol.h"        "${SRC_DIR}/include/hw/misc/cosim_protocol.h"
cp "${ROOT}/bridges/remote_mmio.c"           "${SRC_DIR}/hw/misc/remote_mmio.c"
cp "${ROOT}/processor/systemc_soc.c"         "${SRC_DIR}/hw/arm/systemc_soc.c"
cp "${ROOT}/processor/systemc_ps.c"          "${SRC_DIR}/hw/arm/systemc_ps.c"
